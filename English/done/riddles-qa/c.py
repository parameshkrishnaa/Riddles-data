...
json_data = [
    ...
    {
        "riddle": "A man was going to buy a $5000 car, but he didn't pay a penny for the car, how is this possible?",
    ...
    {
        "riddle": "What is once in a minute, twice in a moment, and never in a thousand years?",
        "answer": "The letter M"
    },
    {
    ...
    {
        "riddle": "In the NBA, how many men are on the basketball court for each team?",
        "answer": "Five....I'll bet you guessed 10"
    },
    {
        "riddle": "There are 20 people in an empty, square room. Each person has full sight of the entire room and everyone in it. If you are not allowed to move in any way (other than your eyes). Where can you place an apple so that all but one person can see it?",
    ...
    {
        "riddle": "What is it that when you take away the whole, you still have some left over?",
        "answer": "Wholesome"
    },
    {
    ...
    {
        "riddle": "Polly Perkins was after a talking parrot, so she went to the local pet shop in the hope of securing such a find. She was in luck. The shop assistant assured her that the parrot would learn and repeat any word or phrase it heard. Polly was delighted. However, a week later, the parrot still hadn't spoken a word. Polly returned to the shop to complain, however, it appeared that the assistant was accurate in what he had said, and refused a refund. Why didn't the parrot talk?",
        "answer": "The parrot was deaf and as such couldn't repeat a single word it had heard!"
    },
    {
    ...
    },
    {
        ...
        "answer": "Sugar She had already put sugar in it and when she tasted the new tea it was already sweet"
    },
    {
        "riddle": "This is as light as a feather, Yet no man can hold it for long. What is it?",
        "answer": "Your Breath"
    },
    {
    ...
    {
        "riddle": "A train was on its way to Florida and derailed. Where would they bury the survivors?",
    ...
    {
        "riddle": "You can spin, wheel and twist, but this thing can turn without moving. What is it?",
        "answer": "Got milk?"
    },
    {
        "riddle": "When they are caught, they are thrown away. When they escape, you itch all day. What are they?",
        "answer": "Fleas"
    },
    {
        "riddle": "You hear it speak, for it has a hard tongue. But it cannot breathe, for it has not a lung. What is it?",
        "answer": "A Bell"
    },
    {
    ...
    },
    {
        ...
        "answer": "He's outside the window Brad was so sick and tired of window washing, he opened the window and jumped inside"
    },
    {
    ...
    {
        "riddle": "What is the easiest way to throw a ball, and have it stop, and completely reverse direction after traveling a short distance?",
    ...
    {
        "riddle": "Inside a burning house, this thing is best to make. And best to make it quickly, before the fire's too much to take!",
        "answer": "Haste!"
    },
    {
    ...
    {
        "riddle": "A black dog stands in the middle of an intersecton in a town painted black. None of the street lights are working due to a power failure caused by a storm. A car with two broken headlights drives towards the dog but turns in time to avoid hitting him. How could the driver have seen the dog in time?",
    ...
    {
        "riddle": "The priest in my hometown told us that on a particular day he would walk on water for 30 minutes. The lake was not dry and we all observed the priest actually walking on water. How?",
        "answer": "It was winter and the lake was frozen"
    },
    {
        "riddle": "Four men sat down to play. They played all night till break of day. They played for gold and not for fun. With separate scores for everyone. When they had come to square accounts. They all had made quite fair amounts. Can you the paradox explain. If no one lost, how all could gain?",
    ...
    {
        "riddle": "You have three stoves: a gas stove, a wood stove, and a coal stove, but only one match. Which should you light first?",
        "answer": "The match!"
    },
    {
    ...
    {
        "riddle": "I have a big mouth and I am also quite loud! I am NOT a gossip but I do get involved with everyone's dirty business. Can you name me?",
    ...
    {
        "riddle": "A petshop owner had a parrot with a sign on its cage that said “Parrot repeats everything it hears.”A young man bought the parrot and for two weeks he spoke to it and it didn't say a word. He returned the parrot but the shopkeeper said he never lied about the parrot. How can this be?",
        "answer": "The parrot was deaf!"
    },
    {
        "riddle": "Three robbers robbed a store. Once they came out they were totally changed, but they still continued robbing. Why?",
        "answer": "They robbed a clothing store; they changed clothes, not their ways"
    },
    {
    ...
    {
        "riddle": "You are in a room where there are no metal objects except for two iron rods. Only one of them is a magnet. How can you identify this magnet?",
        "answer": "You can hang the iron rods on a string and watch which one turns to the north (or hang just one rod)"
    },
    {
    ...
    {
        "riddle": "I am the shortest complete sentence in the English language. What am I?",
    ...
    {
        "riddle": "What goes through the door without pinching itself? What sits on the stove without burning itself? What sits on the table and is not ashamed?",
        "answer": "The Sun"
    },
    {
        "riddle": "The following sentence is false. The preceding sentence is true. Are these sentences true or false?",
    ...
    {
        "riddle": "The faster you work, the longer it is before you're done, and the slower you work, the sooner you're finished?",
    ...
    {
        "riddle": "There was a green house. Inside the green house there was a white house Inside the white house there was a red house. Inside the red house there were lots of babies.",
    ...
    {
        "riddle": "RIDDLE:When asked how old she was, Suzie replied, “In 2 years I will be twice as old as I was 5 years ago.”How old is she?",
    ...
    {
        "riddle": "My first is often at the front door. My second is found in the cereal family. My third is what most people want. My whole is one of the United States.",
        "answer": "RIDDLE:MATRIMONY (mat rye money). Which is certainly a “united state“!"
    },
    {
    ...
    {
        "riddle": "You can see nothing else When you look in my face, I will look you in the eye And I will never lie.",
    ...
    {
        "riddle": "I have an eye but cannot see. I am stronger and faster then any man alive but have no limbs. What am I?",
    ...
    },
    {
        ...
        "answer": "Age He is measuring everyone's feet, including the feet of the very small children. So the statistics will show that larger feet belong to the smarter people, the adults"
    },
    {
    ...
    {
        "riddle": "I have no voice and yet I speak to you, I tell of all things in the world that people do. I have leaves, but I am not a tree, I have pages, but I am not a bride or royalty. I have a spine and hinges, but I am not a man or a door, I have told you all, I cannot tell you more. What am I?",
        "answer": "A Book"
    },
    {
    ...
    },
    {
        ...
        "answer": "The water came from a bowl and something was in it The fish bowl got knocked over. The bodies were goldfish"
    },
    {
    ...
    {
        "riddle": "You heard me before, Yet you hear me again. Then I die, 'Til you call me again What am I?",
        "answer": "An Echo"
    },
    {
    ...
    {
        "riddle": "I can be found on a human or beast all people should have one at least I can be any shape or any size and my history you'll despise  What Am I?",
        "answer": "A Scar"
    },
    {
    ...
    {
        "riddle": "I turn around once. What is out will not get in. I turn around again. What is in will not get out. What am I?",
        "answer": "A Key"
    },
    {
    ...
    {
        "riddle": "How is it possible to shave three times a day and still grow a beard?",
    ...
    {
        "riddle": "How many 1 foot by 1 foot bricks would it take to complete a building that's 20 feet long on all four sides and 20 feet high?",
    ...
    {
        "riddle": "Below is a short poem to help you determine the next letter in the sequence that follows:  Both backward and forward I may go  But just one way makes sense Don't you know  So don't be confused, don't be surprised All you must do  Is use your eyes  What comes next?",
        "answer": "S"
    },
    {
        "riddle": "Violet, indigo, blue and green, yellow, orange and red; these are the colors you have seen after the storm has fled.What am I?",
    ...
    },
    {
        ...
        "answer": "The answer is infinite, if the ball keeps bouncing half way up. But of course on earth gravity will eventually will stop it"
    },
    {
    ...
    {
        "riddle": "I live in the canopy. I rarely touch the forest floor. I hang upside down all day. I move as slow as a tortoise. My hair is brown and green. I eat tree leaves. Who am i?",
        "answer": "Toedsloth"
    },
    {
    ...
    {
        "riddle": "I am always hungry, I must always be fed, The finger I lick Will soon turn red.",
        "answer": "I am Fire"
    },
    {
    ...
    },
    {
        ...
        "answer": "Close your Eyes, what do you seeBob accidentally put his hands over the horse's eyes. If a horse can't see he will automatically stop"
    },
    {
    ...
    {
        "riddle": "Three mountain climbers paid a lot of money to be the first to scale a mountain. After several days of climbing they finally reached the pinnacle, and to their dismay, found a cabin and three frozen bodies. Since the mountain climbers were the first to ever climb the summit, how could this be possible?",
        "answer": "They found a cabin of an airplane that had crashed there with 3 bodies in it"
    },
    {
    ...
    {
        "riddle": "If a man carried my burden He would break his back. I am not rich, But leave silver in my track.",
        "answer": "I am a Snail"
    },
    {
        "riddle": "I was framed, yet I didn't commit a crime, and the person who framed me committed no crime.  How is this possible?",
    ...
    },
    {
        ...
        "answer": "lots of feathers A pound of feathers. Some would say a pound is a pound, but the fact is: Gold is a precious metal and is therefore weighed in the Troy system of measurement. This means that a pound of gold weighs only 12 oz and a pound of feathers weighs 16 oz"
    },
    {
    ...
    {
        "riddle": "Some will use me, while others will not, some have remembered, while others have forgot. For profit or gain, I'm used expertly, I can't be picked off the ground or tossed into the sea. Only gained from patience and time, can you unravel my rhyme?",
    ...
    {
        "riddle": "Which word can be placed between the two following words to make two new ones: TABLE - - - - HOUSE",
        "answer": "WARE"
    },
    {
    ...
    {
        "riddle": "You are on a ship, over the side hangs a rope ladder with half meter rungs. The tide rises a half meter per hour. At the end of five hours, how much of the ladder will remain above the water assuming that nine rungs were above the water when the tide began to rise?",
        "answer": "Remember the tde Nine rungs will be above the water. As the tide rises, so will the ship and the ladder"
    },
    {
        "riddle": "I am a rock group that has 4 members, all of whom are dead, one of which was assasinated. What am I?",
    ...
    {
        "riddle": "My first is in fish but not in snail, My second is in rabbit but not in tail. My third is in up but not in down, My fourth is in tiara but not in crown. My fifth is in tree you plainly see, My whole a food for you and me. What am I?",
        "answer": "I am a fruit"
    },
    {
    ...
    {
        "riddle": "Can you arrange the numbers 1 to 9 in the circles so that each straight line of three numbers totals 18?  {mospagebreak}{mospagebreak}",
        "answer": "Answer:"
    },
    {
    ...
    {
        "riddle": "I make you weak at the worst of all times.  I keep you safe, I keep you fine.  I make your hands sweat, and your heart grow cold,  I visit the weak, but seldom the bold.    Who am I?",
        "answer": "Fear"
    },
    {
    ...
    {
        "riddle": "Joe and Sally where sitting in their family room one night. While Joe was watching T.V, his wife Sally was reading. All of a sudden the power went out and Joe decided to go to bed, but Sally kept on reading. With no use of artificial light, Sally kept on reading. How?",
    ...
    },
    {
        ...
        "answer": "When was he born If he was born before 1783, then Massachusetts would still be a British colony"
    },
    {
    ...
    {
        "riddle": "Three men were walking out one day. Then it started raining hard. They raced 4 blocks to there house. When they got in, one man didnt get his hair wet. They did not have an umbrella, or a hat. How can this be?",
        "answer": "He was bald"
    },
    {
    ...
    {
        "riddle": "I am like day,  you can find me near the river any day,  and you can make almost anything out of me.  who am I?",
        "answer": "clay"
    },
    {
    ...
    {
        "riddle": "I have a heart that never beats, I have a home but I never sleep. I can take a mans house and build anothers, And I love to play games with my many brothers. I am a king among fools. Who am I?",
    ...
    {
        "riddle": "Two convicts are locked in a cell. There is an unbarred window high up in the cell. No matter if they stand on the bed or one on top of the other they can't reach the window to escape. They then decide to tunnel out. However, they give up with the tunneling because it will take too long. Finally one of the convicts figures out how to escape from the cell. What is his plan?",
        "answer": "His plan is to dig the tunnel and pile up the dirt to escape"
    },
    {
        "riddle": "With pointed fangs it sits in wait, With piercing force its doles out fate, Over bloodless victims proclaiming its might, Eternally joining in a single bite. What am I?",
    ...
    {
        "riddle": "If who I am is whom I love, but whom I love is lost.... then who am I?",
    ...
    {
        "riddle": "im a container with the inside golden than cant be opened unless im broken!!!",
        "answer": "an egg"
    },
    {
    ...
    {
        "riddle": "There is a certain family with both girl and boy children. Each of the boys has the same number of brothers as he has sisters. Each of the girls has twice as many brothers as she has sisters. How many boys and girls are there in this family?",
    ...
    {
        "riddle": "its is the beginning of existence and the end of time, its the beginning of everything and the end of space, what am i?",
        "answer": "the letter e"
    },
    {
    ...
    {
        "riddle": "I dig out tiny caves, and store gold and silver in them. I also build bridges of silver and make crowns of gold. They are the smallest you could imagine. Sooner or later everybody needs my help, yet many people are afraid to let me help them. Who am I?",
        "answer": "I am a Dentist"
    },
    {
        "riddle": "When I point up it's bright, but when I point down it's dark. What am I?",
        "answer": "A Light Switch"
    },
    {
        "riddle": "The rich need it  The poor have it  If you eat it you will die  Who am I",
        "answer": "NOTHING"
    },
    {
    ...
    {
        "riddle": "I'm related to you. I'm really close to you!  I'm your cousins aunt. Who am I?",
        "answer": "My Mother"
    },
    {
    ...
    {
        "riddle": "I am thin, tall and I cannot walk but I have a tilted head . What am I!?",
        "answer": "The number 1"
    },
    {
    ...
    {
        "riddle": "Mr. and Mrs. Wilson have five children, half of them are boys.How is this possible?",
    ...
    {
        "riddle": "My first is high, My second damp, My whole a tie, A writer's cramp.",
    ...
    {
        "riddle": "Find the four digit number in which the first digit is one fourth of the last digit, the second digit is 6 times the first digit, and the third digit is the second digit plus 3.",
        "answer": "1694"
    },
    {
    ...
    {
        "riddle": "No legs have I to dance, No lungs have I to breathe, No life have I to live or die And yet I do all three. What am I?",
        "answer": "I am Fire"
    },
    {
    ...
    {
        "riddle": "A man is late for an appointment and, in his haste, takes a corner so fast that only two wheel were on the pavement. A police man is standing on the corner, but he did not give him a ticket. Why?",
    ...
    {
        "riddle": "{ People walk on me day and night. I never sleep...... Who am I?",
        "answer": "A sidewalk"
    },
    {
        "riddle": "Here on Earth it's always true, that a day follows a day. But there is a place where yesterday always follows today!",
        "answer": "In a dictionary"
    },
    {
    ...
    {
        "riddle": "The man who made it doesn't want it, The man who bought it doesn't need it, The man who has it can't see it... What is it???",
    ...
    {
        "riddle": "{ A dad and son are in a car accident  and the dad dies instantly  and the son gets sent to hospital...    The doctors have to operate on him, but one of the doctors turns around and says, “I can't operate on him.... he's my son. ” Who am I??",
        "answer": "his mother"
    },
    {
        "riddle": "I make you weak at the worst of times but in the ned i keep you safe, You will sweat in my presience even as you grow cold, i dwell with the weak and easily the brave but with out me who could tell the difference. Who am I?",
        "answer": "Fear"
    },
    {
        "riddle": "A man was just about to put his key in the door when he heard his wife scream “No Charlie, don't do it!”The man walked in his house to find his wife dead on the floor next to a doctor, a lawyer and a police officer. None of them had name tags and the man did not know who any of them were. The only thing the man knew is that the police officer did it.  How did he know?",
    ...
    {
        "riddle": "a person was building a house, and then it fell down, he did not get hurt nor get mad,on the count on, he knew it was going to fall and he did not expect any one to live in it.what happened?",
    ...
    {
        "riddle": "How can you clasp someone's hands together in such a manner that they cannot leave the room without unclasping them?",
    ...
    {
        "riddle": "You can take off all of my skin and I will not cry but YOU will Why ?",
        "answer": "I'm an onion"
    },
    {
        "riddle": "I am a fruit. I taste very yummy. I came from trees, ofcourse. I am color orange. What am I?",
    ...
    {
        "riddle": "What force and strength cannot get through I with a gentle touch can do, And many in the street would stand were I not a friend in hand.",
        "answer": "A key"
    },
    {
    ...
    {
        "riddle": "I can be created by humans, but they cannot control me. I suck on wood, paper and flesh alike. I can be more of a hindrance than help. To my creators, I seem to be everywhere at once.  What am I?",
        "answer": "A baby"
    },
    {
    ...
    {
        "riddle": "Why did the baseball coach tell the baseball player to go to the bank?",
    ...
    {
        "riddle": "I say everything I hear to others around. I'm not an animal, nor part of the human race. I will, immediately, repeat after you; But only if my tail is in place. What am I?",
        "answer": "A microphone"
    },
    {
        "riddle": "There is a bus full of people travelling over San Francisco and no one gets off the bus throughout the journey. But when it gets to the other side there is not a single person left. How is this possible?",
        "answer": "They are all married"
    },
    {
        "riddle": "A headless lawyer had a letter to write; It was read by a man who had lost his sight. The dumb repeated it word for word; And deaf was he who listened and heard.",
        "answer": "The letter in question is the letter “O“. It is zero. The lawyer had nothing to write. The blind could read nothing. The person who was dumb could repeat nothing. The deaf man listened and heard nothing"
    },
    {
    ...
    {
        "riddle": "Shortly after jumping from an aircraft at 5000 or so feet, a man deploys his parachute. When he looks up he sees a rather large hole in his parachute.  Nonetheless he lands safely without assistance and without using his reserve chute. Why did he survive?",
    ...
    {
        "riddle": "A white dove flew down by the castle. Along came a king and picked it up handless, ate it up toothless, and carried it away wingless.",
    ...
    {
        "riddle": "A doctor and a bus driver are both in love with the same woman, an attractive girl named Sarah. The bus driver had to go on a long bustrip that would last a week. Before he left, he gave Sarah seven apples. Why?",
    ...
    {
        "riddle": "If a man carried my burden he would break his back. I am not big but leave silver in my tracks. What am I?",
        "answer": "A snail"
    },
    {
        "riddle": "Pronounced as one letter, But look and you'll see, That really I'm written with three. I'm read from both ends, The same either way.  What am I?",
    ...
    {
        "riddle": "In marble walls as white as milk, Lined with skin as soft as silk, Within a fountain crystal clear, A golden apple does appear. No doors are there to this stronghold-- Yet thieves break in and steal the gold.",
        "answer": "an egg"
    },
    {
        "riddle": "At dusk I come without being fetched.  At dawn I disappear without being stolen.  I'm a poet's tears and a sailor's guide. What am I ?",
        "answer": "They're in the night sky Stars"
    },
    {
        "riddle": "There is a pink single story house and everything in it is pink. The doors are pink, the windows are pink and the TV is pink. What color are the stairs....",
    ...
    {
        "riddle": "What is that which goes with a carriage, comes with a carriage, is of no use to a carriage, and yet the carriage cannot go without it?",
        "answer": "Noise"
    },
    {
    ...
    {
        "riddle": "The higher I climb, the hotter I engage, I can not escape my crystal cage. What am I?",
        "answer": "Mercury in a thermometer"
    },
    {
        "riddle": "Poke your fingers in my eyes and I will open wide my jaws. Linen cloth, quills, or paper, my greedy lust devours them all.",
        "answer": "Shears, or scissors"
    },
    {
        "riddle": "When I am young I am tall. When I am old I am short.  What can I be?",
    ...
    {
        "riddle": "so your in a mansion and the powers out. you see a green door and a red door which do you go through (It does'nt matter which door). Now you see a purple door and a orange door which do you go through. now you see a door with a golden handle and a door with a silver handle which door do you go through no you finally come to some signs 1 says death from drowning another says death from machine guns and the last 1 says death from electric chair (all the signs are on doors). then you see a big sign that says or stay in the mansion and starve to death. which do you do and also live.",
    ...
    {
        "riddle": "A cloud was my mother, the wind is my father, my son is the cool stream, and my daughter is the fruit of the land. A rainbow is my bed, the earth my final resting place, and I'm the torment of man.",
        "answer": "Rain"
    },
    {
    ...
    {
        "riddle": "Why Does  1 = 3  2 = 3  3 = 5  4 = 4  5 = 4  6 = 3  7 = 5  8 = 5  9 = 4  10 = 3",
        "answer": "Just count how many letters are in the number  For Example  1 has 3 letters  2 has 3 letters  3 has 5 letters  4 has 4 letters  5 has 4 letters and so on"
    },
    {
    ...
    {
        "riddle": "I have a little house in which I live all alone. It has no doors or windows, and if I want to go out I must break through the wall.",
    ...
    {
        "riddle": "if you stack thousands of pizza pies on top of eachother what would you get?",
    ...
    {
        "riddle": "if you're paddling upstream in a canoe and a wheel falls off, how many pancakes are in the doghouse?",
    ...
    {
        "riddle": "Some try to hide, some try to cheat, but time will show, we always will meet. Try as you might, to guess my name, I promise you'll know, when you I do claim. Who am I?",
        "answer": "Death"
    },
    {
        "riddle": "There was a buss with 26 people in it. Then, they decided to cross the Golden Gate Bridge. When they crossed the bridge, there was no single person left. Also, no one got out from the bus. What happened?",
    ...
    {
        "riddle": "What is round as a dishpan, deep as a tub, and still the oceans couldn't fill it up?",
        "answer": "A sieve"
    },
    {
        "riddle": "A kind man comes across a dirty box, a voice says to him “Coconuts, $5 a dozen”With his lightning quick arithmetic he calculates that if he sold those same coconuts to the coconut air assault team for the accepted rate of $3 per dozen that in no time at all he would be a millionaire. What's with this guy, assuming his math is accurate?",
        "answer": "He was a billionaire"
    },
    {
        "riddle": "If you spell out all the numbers, how far do you have to go until you use the letter a?",
        "answer": "one thousand"
    },
    {
    ...
    {
        "riddle": "There were five men going to church and it started to rain. The four that ran got wet and the one that stood still stayed dry.",
    ...
    },
    {
        ...
        "answer": "Brian Brown drove the BMW, Alan Andrew's drove the Avenger, and Colin Cooper drove the Cortina"
    },
    {
        "riddle": "My voice rises above the din, Sometimes catching all unaware. I never ask questions, yet get many answers.",
    ...
    {
        "riddle": "There are four brothers in this world that were all born together. The first runs and never wearies. The second eats and is never full. The third drinks and is always thirsty. The fourth sings a song that is never good.",
    ...
    {
        "riddle": "Four children, Rob, Danny, Martha and Bent, had a race across the yard. Danny was as many places behind Martha as Bent was ahead of Rob. Martha was not first and Rob was not second.  Who was first, second, third and fourth?",
    ...
    {
        "riddle": "There was a yellow eye on a blue face, and a red eye on a green face. The yellow eye said to the red eye “we are both the same, only i'm higher, and you are lower“. What are they?",
        "answer": "The sun in the sky, and a rose on the grass"
    },
    {
        "riddle": "The two dice in each pair are identical. As usual, the numbers on opposite sides add up to seven.  On each pair, what is the total of the two hidden sides that face each other?   CLUE:Dice A has a 5 and 3{mospagebreak}",
        "answer": "Dice A.) 5 + 3 = 8  Dice B.) 4 + 4 = 8"
    },
    {
        "riddle": "life after death it repeats it's self, green to brown it is neither men nor women. what am I?",
        "answer": "a tree"
    },
    {
        "riddle": "Inspector Morse was outside a milkbar when a lady screamed 'NO JOHN NO!!' inspector Morse ran inside the milkbar and inside there was a woman dead on the floor in the Bar there was a lawyer , a milkman , a singer , a teacher and the shop owner . Without hesitation Inspector Morse arrested the milkman. Why is this ?",
        "answer": "Because the milkman was the only male"
    },
    {
        "riddle": "What has no heart Yet is alive? It never moves People stab it with knives.",
        "answer": "A tree"
    },
    {
        "riddle": "A father's child, a mother's child, yet no one's son. Who am I?",
    ...
    {
        "riddle": "I've got ten or more daughters. I've got less than ten daughters. I've got at least one daughter. If only one of these statements is true, how many daughters have I got?",
    ...
    {
        "riddle": "I come at the end of time and at the start of eternitiy. I come four times in every week, but only once in a thousand years. What am I?",
        "answer": "The letter E."
    }
]
...
# Save as TSV
df.to_csv("output2.tsv", sep="\t", index=False)
